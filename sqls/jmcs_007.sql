alter table dba.cs_items_simulaciones  add
       hembras_inician_replume numeric(18,0) null,
       machos_inician_replume numeric(18,0) null;
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'hembras_inician_replume', 35,
        'Hembras Inician Replume:', 0 ,
        'Hembras Inician Replume', 0,
       24 , '[General]',
       0 , 65 , 421 ,
        '', 'N',
        '',
        'Numero de hembras que habia al iniciar el replume',
        '', '');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'cs_items_simulaciones',
        object_id('dba.cs_items_simulaciones'),
        'dba',  'machos_inician_replume', 36,
        'Machos Inician Replume:', 0 ,
        'Machos Inician Replume', 0,
       24 , '[General]',
       0 , 65 , 421 ,
        '', 'N',
        '',
        'numero de machos que habia al iniciar el replume',
        '', '');
