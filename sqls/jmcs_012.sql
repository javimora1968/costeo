create table dba.si_config
       (id_empresa char(15) not null,
       ind_forzar_version char(1) not null,
       fec_version datetime not null);

alter table dba.si_config
       add constraint pk_si_config primary key  nonclustered
       (id_empresa);
